...
const Login = () => {
  ...
  if (isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 via-green-50 to-pink-50 dark:from-slate-900 dark:via-blue-900 dark:via-purple-900 dark:to-indigo-900 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 via-green-50 to-pink-50 dark:from-slate-900 dark:via-blue-900 dark:via-purple-900 dark:to-indigo-900 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-r from-green-300/20 to-emerald-300/20 rounded-full animate-bounce delay-300"></div>
        <div className="absolute top-1/2 left-1/4 w-20 h-20 bg-gradient-to-r from-purple-300/20 to-pink-300/20 rounded-full animate-pulse delay-700"></div>
      </div>
